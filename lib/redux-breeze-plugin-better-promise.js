(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('perfect-immutable')) :
	typeof define === 'function' && define.amd ? define(['exports', 'lodash', 'perfect-immutable'], factory) :
	(factory((global['redux-breeze-plugin-better-promise'] = {}),global._,global.perfectImmutable));
}(this, (function (exports,_,perfectImmutable) { 'use strict';
  ...
  return {
        ...
        return function () {
          ...
          switch (action.type) {
            case createActionType(actionName):
              return perfectImmutable.set(state, defineProperty({}, 'pending.' + actionName, true));
            case createActionType(actionName, 'success'):
              return perfectImmutable.set(state, _extends((_babelHelpers$extends = {}, defineProperty(_babelHelpers$extends, 'pending.' + actionName, false), defineProperty(_babelHelpers$extends, 'lastSucceeded.' + actionName, true), defineProperty(_babelHelpers$extends, 'lastFailed.' + actionName, false), defineProperty(_babelHelpers$extends, 'succeeded.' + actionName, true), _babelHelpers$extends), actionDefinition.result ? getResultsAssignments(actionDefinition.result, action, state) : defineProperty({}, 'result.' + actionName, action.result)));
            case createActionType(actionName, 'error'):
              return perfectImmutable.set(state, _extends((_babelHelpers$extends2 = {}, defineProperty(_babelHelpers$extends2, 'pending.' + actionName, false), defineProperty(_babelHelpers$extends2, 'lastSucceeded.' + actionName, false), defineProperty(_babelHelpers$extends2, 'lastFailed.' + actionName, true), defineProperty(_babelHelpers$extends2, 'failed.' + actionName, true), _babelHelpers$extends2), actionDefinition.error ? getResultsAssignments(actionDefinition.error, action, state) : defineProperty({}, 'error.' + actionName, action.error)));
            default:
              return state;
          }
        };
    ...
    initialStateAdapter: {
      'better-promise': function betterPromise(actionDefinition, actionName) {
        ...
        return _extends((_babelHelpers$extends3 = {}, defineProperty(_babelHelpers$extends3, 'pending.' + actionName, false), defineProperty(_babelHelpers$extends3, 'lastSucceeded.' + actionName, false), defineProperty(_babelHelpers$extends3, 'lastFailed.' + actionName, false), defineProperty(_babelHelpers$extends3, 'succeeded.' + actionName, false), defineProperty(_babelHelpers$extends3, 'failed.' + actionName, false), _babelHelpers$extends3), actionDefinition.result ? getInitialStateAssignments(actionDefinition.result) : defineProperty({}, 'result.' + actionName, null), actionDefinition.error ? getInitialStateAssignments(actionDefinition.error) : defineProperty({}, 'error.' + actionName, null), actionDefinition.initial || {});
      }
    }
  };
};

exports['default'] = createBetterPromisePlugin;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=redux-breeze-plugin-better-promise.js.map
